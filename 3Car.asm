...
;       en el bUfer, y comprueba si se ha superado el     ;
;       lImite de símbolos. Si no se ha superado,         ;
;       vuelve a leer, mientras que si se ha superado,    ;
;       salta un error por dimensión invAlida.            ;
...
;       error de cOdigo inválido. Si es un carácter       ;
;       invAlido, salta un mensaje de error.              ;
;       Para traducir, comprueba si el Indice de          ;
...
;       Ultimo, vuelve a la línea donde se llama a la     ;
;       subrutina que limpia el bUfer. Posteriormente,    ;
;       comprueba si se ha introducido un punto o         ;
;       raya. Si es asI, lo guarda en el bUfer,           ;
;       verificando que no se haya superado el lImite     ;
;       de 5 sImbolos. Si es un espacio o retorno,        ;
;       traduce el carActer guardado en el bUfer. Si      ;
